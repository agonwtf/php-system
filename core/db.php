...
class db extends \PDO
{
    ...
    {
        $cols_output = is_array($columns) ? implode(',', $columns) : $columns;
        $this->sql = str_replace('*', $cols_output, $this->sql);
        return $this;
    }
    ...
    public function pagination($totalRecord, $paginationLimit, $pageParamName)
    {
        ...
        $this->page = isset($_GET[$pageParamName]) && is_numeric($_GET[$pageParamName])  && $_GET[$pageParamName] != 0 ? $_GET[$pageParamName] + 1 : 1;
